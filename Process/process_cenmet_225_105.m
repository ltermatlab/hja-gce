...
source          = 'fetch_cenmet_225_105';
load 'C:\Users\kennedad\Dropbox\matlab\gce_datatools_380_gce_production\userdata\FINAL_AIRTEMP_QC4SIGMA_leap_ak.mat';    %added 20141217 to account for new qc stats file
qc_source       = data;
clear data
template        = 'LNDB_CenMet_1';
sitecode        = 'CENMET_225';
profile         = 'LNDB_HJA_CenMet_105';
...
fn_dest         = sprintf('cenmet_225_5min_%d.mat', c(1));
reprocess       =1;
...
% pn_xml         = strcat(pn_dest_root,'CENMET\dash\225_105');
