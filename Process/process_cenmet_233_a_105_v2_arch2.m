...
source          = 'fetch_cenmet_233_a_105_arch2';
...
sitecode        = 'CENMET_233';
profile         = 'LNDB_HJA_CenMet_233_a_5min'; %slightly modified profile due to massive wiring overhaul
%profile_hrly    = 'LNDB_HJA_CenMet_233_a_hrly';
%profile_dly     = 'LNDB_HJA_CenMet_233_a_dly';
...
fn_dest         = sprintf('cenmet_233_a_5min_%d.mat', c(1));
%fn_dest_hrly    = sprintf('cenmet_233_a_hrly_%d.mat', c(1));
%fn_dest_dly     = sprintf('cenmet_233_a_dly_%d.mat', c(1));
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'CENMET\dash\233_a_105');
