...
qc_source       = data;
clear data
template        = 'LNDB_Cs2Met_2';
sitecode        = 'CS2MET_113';
profile         = 'LNDB_HJA_Cs2Met_113_a_105';
...
fn_dest         = sprintf('cs2met_113_a_5min_%d.mat', c(1));
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'CS2MET\dash\113_a_105');
