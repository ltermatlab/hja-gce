...
source          = 'fetch_greenb_401_115';
template        = 'LNDB_Green_2';
sitecode        = 'GREENA_401';
profile         = 'LNDB_HJA_GREENB_401_15min';
profile_dly     = 'LNDB_HJA_GREENB_401_dly';
...
fn_dest         = sprintf('GREEN_401_a_15min_%d.mat', c(1));
fn_dest_dly     = sprintf('GREEN_401_a_dly_%d.mat', c(1));
reprocess       =1;
...
pn_xml         = strcat(pn_dest_root,'MISC\GREEN\dash\401_b_115');
