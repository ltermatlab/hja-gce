...
source          = 'fetch_gsmack_111_115';
template        = 'LNDB_GsMACK_2';
sitecode        = 'GSMACK_111';
profile         = 'LNDB_GsMack_115';
...
fn_dest         = sprintf('gsmack_111_15min_%d.mat', c(1));
...
% pn_xml         = strcat(pn_dest_root,'GSMACK\dash\111_115');
...
%        msg = gsmack_105_harvest_dashboard( ...
