...
source          = 'fetch_gsws01_101_115';
template        = 'LNDB_GsWS01_2';
sitecode        = 'GSWS01_101';
profile         = 'LNDB_GsWs01_115';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'GSWS01');
pn_plots        = strcat(pn_dest_root,'GSWS01');
c               = clock; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('gsws01_101_15min_%d.mat', c(1));
...
% pn_xml         = strcat(pn_dest_root,'GSWS01\dash\101_105');
...
%        msg = gsws01_105_harvest_dashboard( ...
