...
source          = 'fetch_gsws02_102_115';
template        = 'LNDB_GsWS02_2';
sitecode        = 'GSWS02_102';
profile         = 'LNDB_GsWs02_115';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'GSWS02');
pn_plots        = strcat(pn_dest_root,'GSWS02');
c               = clock; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('gsws02_102_15min_%d.mat', c(1));
...
% pn_xml         = strcat(pn_dest_root,'GSWS02\dash\102_105');
...
%        msg = gsws02_105_harvest_dashboard( ...
