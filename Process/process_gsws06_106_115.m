...
source          = 'fetch_gsws06_106_115';
template        = 'LNDB_GsWS06_2';
sitecode        = 'GSWS06_106';
profile         = 'LNDB_GsWs06_115';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'GSWS06');
pn_plots        = strcat(pn_dest_root,'GSWS06');
c               = clock; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('gsws06_106_15min_%d.mat', c(1));
...
% pn_xml         = strcat(pn_dest_root,'GSWS06\dash\106_105');
...
%        msg = gsws06_105_harvest_dashboard( ...
