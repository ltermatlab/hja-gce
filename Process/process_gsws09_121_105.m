...
source          = 'fetch_gsws09_121_105';
template        = 'LNDB_GsWS09_3';
sitecode        = 'GSWS09_121';
profile         = 'LNDB_GsWs09_105';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'GSWS09');
pn_plots        = strcat(pn_dest_root,'GSWS09');
c               = 2015; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('gsws09_121_5min_%d.mat', c(1));
...
pn_xml         = strcat(pn_dest_root,'GSWS09\dash\121_a_105');
