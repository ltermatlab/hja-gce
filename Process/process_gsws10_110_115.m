...
source          = 'fetch_gsws10_110_115';
template        = 'LNDB_GsWS10_2';
sitecode        = 'GSWS10_110';
profile         = 'LNDB_GsWs10_115';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'GSWS10');
pn_plots        = strcat(pn_dest_root,'GSWS10');
c               = clock; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('gsws10_110_15min_%d.mat', c(1));
...
% pn_xml         = strcat(pn_dest_root,'GSWS10\dash\110_105');
...
%        msg = gsws10_105_harvest_dashboard( ...
