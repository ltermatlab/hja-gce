...
source          = 'fetch_hagg_01_TmpCnd_MP2';
template        = 'LNDB_WS1_StreamCarbon';
sitecode        = 'STREAMCARBON_WS01';
profile         = 'LNDB_HJA_hagg_01_TmpCnd_MP2';
...
fn_dest         = sprintf('hagg_01_TmpCnd_MP2_10min_%d.mat', c(1));
...
pn_xml         = strcat(pn_dest_root,'MISC\STREAMCARBON\dash\MP2');
