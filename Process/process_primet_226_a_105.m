...
% Created template 3, Mar. 2, 2015. Added min/max to temperature

%% Define function arguments
source          = 'fetch_primet_226_a_105';
...
sitecode        = 'PRIMET_226';
profile         = 'LNDB_HJA_PriMet_226_a_5min'; %slightly modified profile due to massive wiring overhaul
%profile_hrly    = 'LNDB_HJA_PriMet_226_a_hrly';
%profile_dly     = 'LNDB_HJA_PriMet_226_a_dly';
...
fn_dest         = sprintf('primet_226_a_5min_%d.mat', c(1));
%fn_dest_hrly    = sprintf('primet_226_a_hrly_%d.mat', c(1));
%fn_dest_dly    = sprintf('primet_226_a_dly_%d.mat', c(1));
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'PRIMET\dash\226_a_105');
