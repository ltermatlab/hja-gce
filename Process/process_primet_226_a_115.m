...
qc_source       = data;
clear data
template        = 'LNDB_PriMet_2';
sitecode        = 'PRIMET_226';
profile         = 'LNDB_HJA_PriMet_226_115_a'; %slightly modified profile due to massive wiring overhaul
...
fn_dest         = sprintf('primet_226_a_15min_%d.mat', c(1));
reprocess       =1;
