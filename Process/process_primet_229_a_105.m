...
sitecode        = 'PRIMET_229';
profile         = 'LNDB_HJA_PriMet_229_a_5min';
%profile_hrly    = 'LNDB_HJA_PriMet_229_a_hrly';
%profile_dly     = 'LNDB_HJA_PriMet_229_a_dly';
...
fn_dest         = sprintf('primet_229_a_5min_%d.mat', c(1));
%fn_dest_hrly    = sprintf('primet_229_a_hrly_%d.mat', c(1));
%fn_dest_dly     = sprintf('primet_229_a_dly_%d.mat', c(1));
reprocess       =1;
...
pn_xml         = strcat(pn_dest_root,'PRIMET\dash\229_a_105');
