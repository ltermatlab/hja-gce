...
sitecode        = 'RS10_010';
profile         = 'LNDB_HJA_RS10_hrly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS10');
pn_plots        = strcat(pn_dest_root,'RS\RS10');
fn_dest         = sprintf('RS10_010_hrly.mat');
reprocess       = 1;
