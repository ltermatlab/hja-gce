...
sitecode        = 'RS38_038';
profile         = 'LNDB_HJA_RS38_hrly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS38');
pn_plots        = strcat(pn_dest_root,'RS\RS38');
fn_dest         = sprintf('RS38_038_hrly.mat');
reprocess       = 1;
