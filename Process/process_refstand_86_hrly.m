...
sitecode        = 'RS86_086';
profile         = 'LNDB_HJA_RS86_hrly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS86');
pn_plots        = strcat(pn_dest_root,'RS\RS86');
fn_dest         = sprintf('RS86_086_hrly.mat');
reprocess       = 1;
