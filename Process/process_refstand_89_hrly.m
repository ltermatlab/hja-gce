...
sitecode        = 'RS89_089';
profile         = 'LNDB_HJA_RS89_hrly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS89');
pn_plots        = strcat(pn_dest_root,'RS\RS89');
fn_dest         = sprintf('RS89_089_hrly.mat');
reprocess       = 1;
