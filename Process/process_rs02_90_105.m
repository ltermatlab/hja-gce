...
sitecode        = 'RS02_90';
profile         = 'LNDB_HJA_RS02_90_5min';
% profile_hrly    = 'LNDB_HJA_RS02_90_hrly';
% profile_dly     = 'LNDB_HJA_RS02_90_dly';
...
fn_dest         = sprintf('RS02_90_a_5min_%d.mat', c(1));
% fn_dest_hrly    = sprintf('RS02_90_a_hrly.mat');
% fn_dest_dly     = sprintf('RS02_90_a_dly.mat');
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'RS\RS02\dash\90_a_105');
