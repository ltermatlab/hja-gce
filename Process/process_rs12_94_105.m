...
sitecode        = 'RS12_94';
profile         = 'LNDB_HJA_RS12_94_5min';
% profile_hrly    = 'LNDB_HJA_RS12_94_hrly';
% profile_dly     = 'LNDB_HJA_RS12_94_dly';
...
fn_dest         = sprintf('RS12_94_a_5min_%d.mat', c(1));
% fn_dest_hrly    = sprintf('RS12_94_a_hrly.mat');
% fn_dest_dly     = sprintf('RS12_94_a_dly.mat');
reprocess       =1;
...
pn_xml         = strcat(pn_dest_root,'RS\RS12\dash\94_a_105');
