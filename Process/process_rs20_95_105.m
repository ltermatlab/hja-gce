...
sitecode        = 'RS20_95';
profile         = 'LNDB_HJA_RS20_95_5min';
% profile_hrly    = 'LNDB_HJA_RS20_95_hrly';
% profile_dly     = 'LNDB_HJA_RS20_95_dly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS20');
pn_plots        = strcat(pn_dest_root,'RS\RS20');
c               = 2015; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('RS20_95_a_5min_%d.mat', c(1));
% fn_dest_hrly    = sprintf('RS20_95_a_hrly.mat');
% fn_dest_dly     = sprintf('RS20_95_a_dly.mat');
reprocess       =1;
...
pn_xml         = strcat(pn_dest_root,'RS\RS20\dash\95_a_105');
