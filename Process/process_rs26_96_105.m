...
sitecode        = 'RS26_96';
profile         = 'LNDB_HJA_RS26_96_5min';
% profile_hrly    = 'LNDB_HJA_RS26_96_hrly';
% profile_dly     = 'LNDB_HJA_RS26_96_dly';
pn_dest_root    = localpath('pn_dest_root');
pn_dest_plot    = localpath('pn_plots_root');
html            = localpath('html');
email           = localpath('email');
pn_dest         = strcat(pn_dest_root,'RS\RS26');
pn_plots        = strcat(pn_dest_root,'RS\RS26');
c               = 2015; % c = clock for real-time processing or yyyy for post processing
fn_dest         = sprintf('RS26_96_a_5min_%d.mat', c(1));
% fn_dest_hrly    = sprintf('RS26_96_a_hrly.mat');
% fn_dest_dly     = sprintf('RS26_96_a_dly.mat');
reprocess       =1;
...
pn_xml         = strcat(pn_dest_root,'RS\RS26\dash\96_a_105');
