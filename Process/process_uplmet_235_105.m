...
qc_source       = data;
clear data
template        = 'LNDB_UplMet_2';
sitecode        = 'UPLMET_235';
profile         = 'LNDB_HJA_UplMet_105';
...
fn_dest         = sprintf('uplmet_235_5min_%d.mat', c(1));
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'UPLMET\dash\235_a_105');
