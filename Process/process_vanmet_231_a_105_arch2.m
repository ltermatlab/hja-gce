...
% Table arch2 was a result of a big reconfiguration that removed a lot of
% the air temperature calculations from the logger output. 

%% Define function arguments
source          = 'fetch_vanmet_231_a_105_arch2';
