...
sitecode        = 'VANMET_232';
profile         = 'LNDB_VanMet_232_a_5min';
% profile_hrly    = 'LNDB_VanMet_232_a_hrly';
% profile_dly     = 'LNDB_VanMet_232_a_dly';
...
fn_dest         = sprintf('vanmet_232_a_5min_%d.mat', c(1));
% fn_dest_hrly    = sprintf('vanmet_232_a_hrly_%d.mat', c(1));
% fn_dest_dly     = sprintf('vanmet_232_a_dly_%d.mat', c(1));
reprocess       = 1;
...
pn_xml         = strcat(pn_dest_root,'VANMET\dash\232_a_105');
