...
qc_source       = data;
clear data
template        = 'LNDB_VarMet_3';
qc_template     = 'LNDB_VarMet_QC';
sitecode        = 'VARMET';
profile         = 'LNDB_VARMET_302_105';
...
pn_xml         = strcat(pn_dest_root,'VARA\dash\302_a_105');
