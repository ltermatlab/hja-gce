function [s2,msg] = aggr_stats(s,agcols,statcols,statopt,flagopt,qcrules,tminmax)
%Statistical aggregation function for summarizing or re-sampling GCE Data Structures
%
...
%
%syntax:  [s2,msg] = aggr_stats(s,aggrcols,statcols,statopt,flagopt,qcrules,tminmax)
%
%inputs:
         ...
         if ~isempty(statcols)
            ...
            if ~isempty(s)
               ...
               if length(I_breaks) < numrows
                  ...
                  %(i.e. num, min, max, tot, median, mean, sd, se, missing, consec_missing, 
                  %pct_missing, flagged, pct_flagged, consec_flagged)
                  newdata = cell(1,numcols+numstats.*16);
                  newnames = newdata;
                  ...
                  for n = 1:numstats
                     ...
                     else  %enumerate only (cell or numeric)
