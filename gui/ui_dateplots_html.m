...
if strcmp(op,'init') == 1
   ...
   if length(findobj) > 1
      h_fig = gcf;
      h_dlg = findobj('Tag','dlgDatePlotsHTML');
   ...
   if ~isempty(h_fig)
      ...
      h_dlg = figure('Visible','off', ...
         ...
         'NumberTitle','off', ...
         'Position',[max(10,(res(3)-700).*0.5) max(30,(res(4)-410).*0.5) 700 410], ...
         'Tag','dlgDatePlotsHTML', ...
         'ToolBar','none', ...
         'CloseRequestFcn','ui_dateplots_html(''cancel'')', ...
      ...
      h_editPath = uicontrol('Parent',h_dlg, ...
         ...
         'String',pn, ...
         'Tag','editPath', ...
         'Callback','ui_dateplots_html(''path'')', ...
         'UserData',pn);
      ...
      h_editHTML = uicontrol('Parent',h_dlg, ...
         ...
         'Style','edit', ...
         'String','index.htm', ...
         'Callback','ui_dateplots_html(''buttons'')', ...
         'Tag','editName');
      ...
      h_editCols = uicontrol('Parent',h_dlg, ...
         ...
         'Style','edit', ...
         'UserData',3, ...
         'Callback','ui_dateplots_html(''checknum'')', ...
         'Tag','editCols');
      ...
      h_chkThumbs = uicontrol('Parent',h_dlg, ...
         ...
         'Value',1, ...
         'Callback','ui_dateplots_html(''thumbs'')', ...
         'Tag','chkThumbs');
      ...
      h1 = uicontrol('Parent',h_dlg, ...
         ...
         'String','HTML Navigation Header', ...
         'Style','text', ...
         'Tag','StaticText1');

      h_editHeader = uicontrol('Parent',h_dlg, ...
         'BackgroundColor',[1 1 1], ...
         'FontSize',10, ...
         'Min',1, ...
         'Max',3, ...
      ...
      h_cmdCancel = uicontrol('Parent',h_dlg, ...
         'Callback','ui_dateplots_html(''cancel'')', ...
         'FontSize',10, ...
      ...
      h_cmdProceed = uicontrol('Parent',h_dlg, ...
         'Callback','ui_dateplots_html(''eval'')', ...
         'FontSize',10, ...
      ...
      h_cmdBrowse = uicontrol('Parent',h_dlg, ...
         'Callback','ui_dateplots_html(''browse'')', ...
         'FontSize',10, ...
      ...
      switch op
         ...
         case 'eval'
            ...
            if ~isempty(h_dlg)
               ...
               nav_html = deblank(get(uih.editHeader,'String'));
               closeopt = get(uih.chkClose,'Value');

               if ~isempty(html) && ~isempty(name) && exist(pn) == 7
                  ...
                  msg = dateplot2html(cols,plotwidth,thumbs,interval,name,html,pn,'',nav_html,uih.h_fig);
         ...
         case 'browse'
            ...
            if exist('uigetdir','builtin') == 5 || exist('uigetdir','file') == 2
               ...
               fn = [deblank(get(uih.editName,'String')),'_mmmyy.png'];
               curpath = pwd;
               cd(pn)
         ...
         case 'buttons'
            ...
            if ~isempty(html) & ~isempty(name) & ~isempty(pn) & ~isempty(wid)
