function [msg,status] = cenmet_data_harvester_sql(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
    ...
    if exist(source,'file') == 2
        ...
        if gce_valid(data)
            ...
            if ~isempty(data)
                ...
                interpcols = {'PRECIP_INST_455_0_01','PRECIP_INST_625_0_02'};
            ...
            if ~isempty(col)
                ...
                if ~isempty(col)
                    ...
                    Diffs_455       = cell2mat(Results(:,7));
                    Flag_Diffs_455  = Results(:,8);
                ...
                if ~isempty(col)
                    ...
                    Diffs_625       = cell2mat(Results(:,7));
                    Flag_Diffs_625  = Results(:,8);
