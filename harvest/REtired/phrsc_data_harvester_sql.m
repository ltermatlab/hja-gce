function [msg,status] = phrsc_data_harvester_sql(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
...
if nargin >= 1
    ...
    if exist(source,'file') == 2
        ...
        if gce_valid(data)
            ...
            %begin experimental detection limit notification columns
            if ~isempty(data)
            ...
            if ~isempty(data)
                ...
                if ~isempty(data)
                    ...
                    interpcols = {'CM3_Dn_Avg','CM3_Up_Avg','Cotton_Avg','Gill_AF_Avg', ...
                        'Gill_Lg_Avg','Gill_Sh_Avg','HJA_Lg_Avg','HJA_Sh_Avg','RMY_ASP_Avg'};
