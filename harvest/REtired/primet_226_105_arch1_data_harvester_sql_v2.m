function [msg,status] = primet_226_105_arch1_data_harvester_sql_v2(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
         ...
         if ~isempty(data)
             ...
             if ~isempty(pos)
                 [data,msg] = add_calcexpr(data, ...
                     'PRECIP_CNT_100_0_01 .* 0.01', ...            %calculate precip
                     ...
                     'x<0=''I'';x>1=''Q'';;x>2=''I''', ...             %Q/C using previous units flag criteria for the new column
             ...
             if ~isempty(data)
                 ...
                 col = name2col(data,'SNODEP_INST_0_0_01');
                 if ~isempty(col)
                     md = running_median(extract(data,'SNODEP_INST_0_0_01'),12,1,'back');
                     ...
                     [data,msg] = addcol( ...
                         ...
                         'SNODEP_MED_0_0_01', ...                            % the name of the new column (required)
                 ...
                 % primet snow data in mm always
                 %                  col = name2col(data,'SNODEP_INST_0_0_01');
                 %                  %convert SNODEP_INST_0_0_01 from m to mm
                 %                  if ~isempty(col)
                 %                      [data,msg] = unit_convert(data,'SNODEP_INST_0_0_01','mm');
                 %                  end
                 %                  col = name2col(data,'SNODEP_MED_0_0_01');
                 %                  %convert SNODEP_MED_0_0_01 from m to mm
                 %                  if ~isempty(col)
                 %                      [data,msg] = unit_convert(data,'SNODEP_MED_0_0_01','mm');
                 %                  end
             end
