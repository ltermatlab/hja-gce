function [msg,status] = primet_226_160_a_data_harvester_sql(source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest)
        ...
        if gce_valid(data)
            ...
            if ~isempty(data)
                ...
                if ~isempty(data)
                    ...
                    interpcols = {'RH_150_AVG','RH_450_AVG', ...
                        'VPD_150_AVG','VPD_450_AVG', ...
                        'DEWPT_150_AVG','DEWPT_450_AVG'};
