function [msg,status] = primet_226_a_105_data_harvester_sql(source,template,sitecode,profile,profile_hrly,profile_dly,pn_dest,pn_plots,html,email,fn_dest,fn_dest_hrly,fn_dest_dly,reprocess)
    ...
    if exist(source,'file') == 2
        ...
        if gce_valid(data)
            ...
            if ~isempty(data)
                ...
                if ~isempty(col)
                    md = running_median(s.SNODEP_INST_0_0_01,12,1,'back'); %compute running median of SNODEP_INST_0_0_01
                    ...
                    [data,msg] = addcol( ...
                        ...
                        '12 point running median of SNODEP_INST_0_0_01', ...       % the description for the new column (optional - default = name)
            ...
            if ~isempty(data)
                    ...
                    interpcols = {'AIR_150_AVG','AIR_250_AVG','AIR_350_AVG','AIR_450_AVG', ...
                        ...
                        'RH_150_AVG','RH_450_AVG','PPT_SA_INST','PPT_SH_INST','SNODEP_INST_0_0_01','SWE_INST','SOLAR_AVG', ...
