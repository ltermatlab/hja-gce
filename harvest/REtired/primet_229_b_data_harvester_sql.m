function [msg,status] = primet_229_b_data_harvester_sql(source,template,sitecode,profile,profile_hrly,profile_dly,pn_dest,pn_plots,html,email,fn_dest,fn_dest_hrly,fn_dest_dly,reprocess)
        ...
        if gce_valid(data)
            ...
            if ~isempty(data)
                ...
                interpcols = {'AIRTEMP_MEAN_150_0_04','AIRTEMP_MEAN_250_0_03','AIRTEMP_MEAN_350_0_02','AIRTEMP_MEAN_450_0_01', ...
                    ...
                    'RH_150_AVG','RH_450_AVG','PPT_SA_INST','PPT_SH_INST','SNODEP_INST_0_0_01','SWE_INST_0_0_01','SOLAR_AVG', ...
