    ...
    if exist(source,'file') == 2
        ...
        if gce_valid(data)
            ...
            if ~isempty(col)
                ...
                if ~isempty(data)
                    cols = {'Month','Day','Hour','Year','Minute','RecNum','MEAN','STD','MIN','MAX','MEDIAN'};
...
% %                 %save airtemp to skinny formatted table
% %                 cols = name2col(data,{'AIRTEMP_MEAN_150_0_04','AIRTEMP_MAX_150_0_04','AIRTEMP_MIN_150_0_04', ...
% %                     'AIRTEMP_MEAN_250_0_03','AIRTEMP_MAX_250_0_03','AIRTEMP_MIN_250_0_03', ...
% %                     'AIRTEMP_MEAN_350_0_02','AIRTEMP_MAX_350_0_02','AIRTEMP_MIN_350_0_02', ...
% %                     'AIRTEMP_MEAN_450_0_01','AIRTEMP_MAX_450_0_01','AIRTEMP_MIN_450_0_01', ...
% %                     'AIRTEMP_MEAN_350_0_08','AIRTEMP_MAX_350_0_08','AIRTEMP_MIN_350_0_08', ...
% %                     });
% %                 
% %                 repcols = name2col(data,{'Site','Date','LOGGERID','PROGID'});
% %                 
% %                 if ~isempty(cols)
% %                     [s2,msg] = normalize_cols( ...
% %                         data, ...
% %                         cols, ...
% %                         repcols ...
% %                     );
% %                 
% %                 %save .mat file to destination
% %                 save([pn_data,filesep,'CENT_223_AIRTEMP'],'s2')
% %                 
% %                 %export .csv file with separate metadata in FLED style with q/c flag columns for all
% %                 %data/calc columns (see 'help exp_ascii' for all options)
% %                 exp_ascii( ...
...
% %                     'csv', ...    %file format to export
% %                     'CENT_223_AIRTEMP', ...   %filename for CSV file
% %                     pn_data, ...  %file path for CSV file
% %                     'Air temperature in semi-normalized format', ...       %title string ('' = use data set title)
% %                     'SB', ...     %header format ('SB' = brief header with separate metadata file -meta.txt)
% %                     'MD', ...     %flag display format ('MD' = flag columns for all data/calc columns)
% %                     'FLED' ...    %metadata style
% %                     );
% %                 end
% %                 
% %                 %save dew point to skinny formatted table
% %                 cols = name2col(data,{'DEWPT_MEAN_150_0_04','DEWPT_MIN_150_0_04','DEWPT_MAX_150_0_04', ...
% %                     'DEWPT_MEAN_450_0_01','DEWPT_MIN_450_0_01','DEWPT_MAX_450_0_01'});
% %                 
% %                 repcols = name2col(data,{'Site','Date','LOGGERID','PROGID'});
% %                 
% %                 if ~isempty(cols)
% %                     [s3,msg] = normalize_cols( ...
% %                         data, ...
% %                         cols, ...
% %                         repcols ...
% %                     );
% %                 
% %                 %save .mat file to destination
% %                 save([pn_data,filesep,'CENT_223_DEWPT'],'s3')
% %                 
% %                 %export .csv file with separate metadata in FLED style with q/c flag columns for all
% %                 %data/calc columns (see 'help exp_ascii' for all options)
% %                 exp_ascii( ...
...
% %                     'csv', ...    %file format to export
% %                     'CENT_223_DEWPT', ...   %filename for CSV file
% %                     pn_data, ...  %file path for CSV file
% %                     'Dew point in semi-normalized format', ...       %title string ('' = use data set title)
% %                     'SB', ...     %header format ('SB' = brief header with separate metadata file -meta.txt)
% %                     'MD', ...     %flag display format ('MD' = flag columns for all data/calc columns)
% %                     'FLED' ...    %metadata style
% %                     );
% %                 end
% %                 
% %                 %save to skinny formatted table
% %                 cols = name2col(data,{'RELHUM_MEAN_150_0_04','RELHUM_MEAN_450_0_01'});
% %                 
% %                 repcols = name2col(data,{'Site','Date','LOGGERID','PROGID'});
% %                 
% %                 if ~isempty(cols)
% %                     [s4,msg] = normalize_cols( ...
% %                         data, ...
% %                         cols, ...
% %                         repcols ...
% %                     );
% %                 
% %                 %save .mat file to destination
% %                 save([pn_data,filesep,'CENT_223_RELHUM'],'s4')
% %                 
% %                 %export .csv file with separate metadata in FLED style with q/c flag columns for all
% %                 %data/calc columns (see 'help exp_ascii' for all options)
% %                 exp_ascii( ...
% %                     s4, ...     %data structure to export
% %                     'csv', ...    %file format to export
% %                     'CENT_223_RELHUM', ...   %filename for CSV file
% %                     pn_data, ...  %file path for CSV file
% %                     'Relative humidity in semi-normalized format', ...       %title string ('' = use data set title)
% %                     'SB', ...     %header format ('SB' = brief header with separate metadata file -meta.txt)
% %                     'MD', ...     %flag display format ('MD' = flag columns for all data/calc columns)
% %                     'FLED' ...    %metadata style
% %                     );
