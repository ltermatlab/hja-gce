function [msg,status] = phrsc_data_harvester_sql_v2(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,fn_gap,reprocess)
    ...
    if exist(source,'file') == 2
        ...
        if gce_valid(data)
            ...
            if ~isempty(sitecode)
                ...
                [data,msg,dt_fill] = pad_date_gaps( ...
                    data, ...   %data structure to update
                    [], ...     %date column ([] = auto)
                ...
                msg = gap_fill_report( ...
                    ...
                    'Date', ...                                     %colname = name for the filled value column
                ...
                interpcols = {'Cotton_Avg','Gill_AF_Avg','Gill_Lg_Avg', ...
                    'Gill_Sh_Avg','HJA_Lg_Avg','HJA_Sh_Avg','RMY_ASP_Avg'};
            ...
            %structure
            col = name2col(data,{'Cotton_Avg','Gill_AF_Avg','Gill_Lg_Avg','Gill_Sh_Avg ', ...
                'HJA_Lg_Avg ','HJA_Sh_Avg ','RMY_ASP_Avg '}); % check for column to qc
            if ~isempty(col)
            ...
            if ~isempty(data)
                ...
                col = name2col(data,{'CM3_Up_Avg','CM3_Dn_Avg'});
                if ~isempty(col)
                    [data,msg] = num_replace(data, ...
                        {'CM3_Up_Avg','CM3_Dn_Avg'}, ...                     %columns to update
                        'CM3_Up_Avg < 1', ...                               %criteria to match
...
%             end
            ...
            if ~isempty(data)
                ...
                save([pn_data,filesep,fn_dest],'data')  % save the datastructure as a .mat file
