function [msg,status] = refstand_data_harvester_sql(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
    ...
    if exist(source,'file') == 2
      ...
      if gce_valid(data)
         ...
         if ~isempty(data)
             ...
             interpcols = {'AIRTEMP_MEAN_225_0_01','AIRTEMP_MEAN_225_0_02','AIRTEMP_MEAN_225_0_03','AIRTEMP_MEAN_225_0_04', ...
                 'SOILTEMP_MEAN_0_10_01','SOILTEMP_MEAN_0_20_02','SOILTEMP_MEAN_0_30_03'};
         ...
         %begin elevated qc routine using seperate qc_stats file
            ...
            %structure
            col = name2col(data,{'AIRTEMP_MEAN_225_0_01'}); % check for column to qc
            if ~isempty(col)
...
%
%          %check for target variables in PRIM_230_115 for database inserts
%          col = name2col(data,{'Site','Date','BP_INST','FLAG_BP_INST','SOLAR_AVG','FLAG_SOLAR_AVG'});
%          if ~isempty(col)
%              %convert flags to text
%              [data,msg] = flags2cols(data,'alldata',0,0,1,0,'FLAG_',0);
%              %connect to the database
%               conn = database('metdat1', '', '', 'Vendor', 'MICROSOFT SQL SERVER', 'Server', 'Stewartia', 'PortNumber', 1433, 'AuthType', 'Windows');
%              %send data back to metdat1 database
%               msg = gce_fastinsert(data, ...
%                   conn, ...
%                   'PRIM_TEST_4', ...
%                   {'Site','Date','BP_INST','FLAG_BP_INST','SOLAR_AVG','FLAG_SOLAR_AVG'}, ...
%                   [] ...
%               );
...
%          end
%          
%          %check for target variables in PRIM_230_160 for database inserts
%          col = name2col(data,{'Site','Date','SOIL_100_AVG','FLAG_SOIL_100_AVG','SOIL_10_AVG','FLAG_SOIL_10_AVG','SOIL_20_AVG','FLAG_SOIL_20_AVG','SOIL_50_AVG','FLAG_SOIL_50_AVG','WCR_10_AVG','FLAG_WCR_10_AVG','WCR_100_AVG','FLAG_WCR_100_AVG','WCR_20_AVG','FLAG_WCR_20_AVG','WCR_50_AVG','FLAG_WCR_50_AVG'});
%          if ~isempty(col)
%              %convert flags to text
%              [data,msg] = flags2cols(data,'alldata',0,0,1,0,'FLAG_',0);
%              %connect to the database
...
%                   conn, ...
%                   'PRIM_TEST_5', ...
%                   {'Site','Date','SOIL_100_AVG','FLAG_SOIL_100_AVG','SOIL_10_AVG','FLAG_SOIL_10_AVG','SOIL_20_AVG','FLAG_SOIL_20_AVG','SOIL_50_AVG','FLAG_SOIL_50_AVG','WCR_10_AVG','FLAG_WCR_10_AVG','WCR_100_AVG','FLAG_WCR_100_AVG','WCR_20_AVG','FLAG_WCR_20_AVG','WCR_50_AVG','FLAG_WCR_50_AVG'}, ...
%                   [] ...
%               );
%              %close database connection
%              close(conn);
%          end
%          
%          %check for target variables in PRIM_229_snc_avg for database inserts
%          col = name2col(data,{'Site','Date','WINDDIR_SNC_AVG','FLAG_WINDDIR_SNC_AVG','WINDDIR_SNC_STD','FLAG_WINDDIR_SNC_STD','WINDSP_SNC_AVG','FLAG_WINDSP_SNC_AVG','AIR_SNC_AVG','FLAG_AIR_SNC_AVG'});
%          if ~isempty(col)
%              %convert flags to text
%              [data,msg] = flags2cols(data,'alldata',0,0,1,0,'FLAG_',0);
%              %connect to the database
...
%                   conn, ...
%                   'PRIM_TEST_6', ...
%                   {'Site','Date','WINDDIR_SNC_AVG','FLAG_WINDDIR_SNC_AVG','WINDDIR_SNC_STD','FLAG_WINDDIR_SNC_STD','WINDSP_SNC_AVG','FLAG_WINDSP_SNC_AVG','AIR_SNC_AVG','FLAG_AIR_SNC_AVG'}, ...
%                   [] ...
%               );
%              %close database connection
%              close(conn);
