function [msg,status] = streamt_data_harvester_sql(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
      ...
      if gce_valid(data)
         ...
         %check for optional sitecode, add to beginning of data set and document in metadata
            ...
            if ~isempty(data)
                ...
                interpcols = {'AIR_SN_AVG','H20_SN_AVG','H2O_SN_MACK_AVG','H2O_SN_LOOK_AVG'};
         ...
         %begin elevated qc routine using seperate qc_stats file
            ...
            %structure
            col = name2col(data,{'AIR_SN_AVG','AIR_SN_MAX','AIR_SN_MIN'}); % check for column to qc
            if ~isempty(col)
            ...
            %
            %code for finalizing the structure goes here
            %
