function ind = insidepoly(x,y,xv,yv,tol)
%Determines if points are inside/outside of a polygon
%
%syntax: ind = insidepoly(x,y,xv,yv,tol)
%
%input:
%  x = array of x values for test coordinates
%  y = array of y values for test coordinates
%  xv = array of polygon x values
%  yv = array of polygon y values
%  tol = tolerance criteria for identifying nearby points (default = 1e-6)
%
%output:
%  ind = match index
%     0 = x(i),y(i) is outside the polygon xv,yv
%     1 = x(i),y(i) is inside the polygon xv,yv
%     2 = x(i),y(i) is near (but outside) the polygon xv,yv
%
%Note: this code was provided by Rich Pawlowicz, and obtained from 
%  http://woodshole.er.usgs.gov/operations/sea-mat/ as public domain software
%
