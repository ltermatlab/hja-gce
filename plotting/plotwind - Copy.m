function [msg,h_fig] = plotwind(s,col_date,col_speed,col_dir,maxspeed,daterange,deblank,showflags,linespec_speed,linespec_dir,markersize_speed)
...
%
%syntax: [msg,h_fig] = plotwind(s,col_date,col_speed,col_dir,maxspeed,daterange,deblank,showflags,linespec_speed,linespec_dir,markersize_speed)
%
%inputs:
%  s = data structure
   ...
   if gce_valid(s,'data')
      ...
      if ~isempty(col_date) && ~isempty(col_speed) && ~isempty(col_dir)
         ...
         if ~isempty(d) && ~isempty(spd) && ~isempty(dir)
            ...
            %create plot figure
            h_fig = figure('Name','Wind Data Plot', ...
               'Numbertitle','off', ...
               'Toolbar','none', ...
               'Color',[1 1 1], ...
