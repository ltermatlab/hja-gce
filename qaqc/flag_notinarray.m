function Iflag = flag_notinarray(vals,valuearray,tolerance)
%Returns an index of numeric values that are not present in a specified array
%for performing quality control analysis of coded numeric values
%
%syntax: Iflag = flag_notinarray(vals,valuearray,tolerance)
%
%inputs:
...
if nargin >= 2
   ...
   if isnumeric(vals) && isnumeric(valuearray) && ~isempty(vals) && ~isempty(valuearray)
      ...
      Imatch = inarray(vals,valuearray,tolerance);
