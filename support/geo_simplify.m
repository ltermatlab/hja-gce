...
%Simplifies a geographic polygon by reducing the number of lon/lat vertices
%
%syntax: [olon, olat] = geo_simplify(lon, lat, nmax, tolerance)
%
%input:
%  lon = nx1 numeric array of vertex longitudes in decimal degrees
%  lat = nx1 numeric array of vertex latitudes in decimal degrees
%  nmax = maximum number of vertex coordinates to return
%  tolerance = tolerance for determining coordinates to omit (default = 0)
%
%output:
%  olon = simplified longitude array
%  olat = simplified latitude array
%
%
%Copyright (C) 1997 Dr. Charles R. Denham, ZYDECO (downloaded from 
