...
%
%   S = URLREAD(URL,METHOD,PARAMS,TIMEOUT) passes information to the server as
...
% =========================================================================
%
% additional modifications by Wade Sheldon 31-Aug-2008
...
% Set default timeout (90s) - Wade Sheldon
