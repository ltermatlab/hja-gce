...
version 1.02 (01-Jul-2013)

Copyright 2012-2013 Wade M. Sheldon and the Georgia Coastal Ecosystems LTER Program
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="code">
      ...
      <xsl:text>%&#xD;&#xA;</xsl:text>
      <xsl:text>%auto-generated by EMLdataset2mfile.xsl v1.02 (http://gce-lter.marsci.uga.edu/public/xsl/toolbox/EMLdataset2mfile.xsl)&#xD;&#xA;</xsl:text>
